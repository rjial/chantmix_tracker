        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="border-l dark:border-gray-600 h-6"></div>
              <div>
                <h1 className="text-2xl font-bold text-gray-800 dark:text-white">{chantData.song.title}</h1>
                <p className="text-gray-600 dark:text-gray-300">by {chantData.song.artist}</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <Link
                to="/new/$id"
                params={{ id }}
                className="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded transition-colors flex items-center gap-2"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-center gap-4">
                  ...
                  <button
                    ...
                    disabled={!isReady}
                    className="bg-blue-500 hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-800 text-white font-bold py-3 px-6 rounded transition-colors disabled:opacity-50"
                  >
            ...
            {/* Chant Info */}
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
              <h3 className="text-lg font-semibold mb-4 text-gray-800 dark:text-white">Chant Information</h3>
              <div className="space-y-3 text-sm">
                <div>
                  <span className="font-medium text-gray-700 dark:text-gray-300">Contributor:</span>
                  <span className="ml-2 text-gray-600 dark:text-gray-400">{chantData.metadata.contributor}</span>
                </div>
                {chantData.metadata.description && (
                  <div>
                    <span className="font-medium text-gray-700 dark:text-gray-300">Description:</span>
                    <p className="text-gray-600 dark:text-gray-400 mt-1">{chantData.metadata.description}</p>
                  </div>
                )}
                <div>
                  <span className="font-medium text-gray-700 dark:text-gray-300">Total Lyrics:</span>
                  <span className="ml-2 text-gray-600 dark:text-gray-400">{chantData.metadata.totalLyrics}</span>
                </div>
                <div>
                  <span className="font-medium text-gray-700 dark:text-gray-300">Duration:</span>
                  <span className="ml-2 text-gray-600 dark:text-gray-400">{chantData.metadata.durationFormatted}</span>
                </div>
          ...
          {/* Right Column - Lyrics */}
          <div className="bg-black dark:bg-black rounded-lg shadow-md overflow-hidden">
            <div className="p-4 border-b border-gray-800">
              <h3 className="text-lg font-semibold text-white text-center">🎤 Karaoke ({chantData.lyrics.length})</h3>
